...
function HeroSection() {
  return (
    <div className="absolute contents left-[-1039.43px] top-[-657.41px]" data-name="Hero Section">
          ...
          <div className="h-[751.015px] relative w-[1920px]" data-name="Gradient">
            <div className="absolute inset-[-13.32%_-5.21%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 2120 952">
                <g filter="url(#filter0_f_12_1020)" id="Gradient">
                  <path d={svgPaths.p26172b00} fill="var(--fill-0, #11112B)" />
                </g>
                <defs>
                  <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="951.015" id="filter0_f_12_1020" width="2120" x="0" y="-2.27224e-06">
                    <feFlood floodOpacity="0" result="BackgroundImageFix" />
                    <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
                    <feGaussianBlur result="effect1_foregroundBlur_12_1020" stdDeviation="50" />
                  </filter>
                </defs>
              </svg>
            </div>
      ...
      <div className="absolute flex h-[2639.24px] items-center justify-center left-[-1039.43px] top-[-657.41px] w-[3300.06px]">
...
function Frame2121451009() {
  return (
    <div className="absolute content-stretch flex flex-col gap-px h-[2497px] left-0 top-[647px] w-[1440px]">
      {/* items-end */}
      <Group2085664664 />
    </div>
  );
...
function ScOurServicesDesktop() {
  return (
    <div className="absolute bg-[#11112b] h-[5110px] left-0 overflow-clip top-0 w-[1440px]" data-name="SC Our Services - Desktop">
...
export default function OurServicepage() {
  return (
    <div className="relative size-full" data-name="OurServicepage">
      <ScOurServicesDesktop />
    </div>
  );
}